...
parser.add_argument('--load', type=str, default='pretrain/nextvit_base_in1k6m_384.pth', help='train from checkpoints')
parser.add_argument('--load_pre', type=str, default='./CATNet_RGBD_cpts/CATNet_epoch_best.pth', help='train from checkpoints')
